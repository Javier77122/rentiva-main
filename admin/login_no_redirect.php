<?php
// FORCE NO SESSION CHECK - Direct login form
// This version will NEVER redirect to dashboard automatically

// Only start session for form processing, not for checking existing sessions
if ($_POST) {
    session_start();
